  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        "pricing-gradient":
          "linear-gradient(99.45deg, rgba(207, 246, 254, 0.32) 5.65%, rgba(191, 244, 255, 0.51) 14.88%, rgba(145, 189, 255, 0.292255) 48.78%, rgba(238, 212, 250, 0.32) 79.47%, rgba(238, 239, 180, 0.28) 94.28%)",
        "hero-gradient":
